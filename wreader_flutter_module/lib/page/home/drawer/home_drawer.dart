...
import 'package:wreader_flutter_module/page/home/host/state.dart';
...
/// [Scaffold] 使用 Drawer 搭配 FishRedux 会带来许多问题要解决,太恶心了,不用了
class HomeDrawer extends StatefulWidget {
  @override
  State<StatefulWidget> createState() =>
      _HomeDrawerState(MainState.globalBrightnessMode);
}

class _HomeDrawerState extends State<HomeDrawer> {
  int mode;

  _HomeDrawerState(this.mode);
  ...
  void deactivate() {
    if (ModalRoute.of(context).isCurrent) {
      println("deactivate:回到首页来了");
      HomeState.isHomeDrawer = true;
    } else {
      println("deactivate:不是首页");
      HomeState.isHomeDrawer = false;
    }
    super.deactivate();
  }
  ...
  _obtainDisplayName() {
    println("MainState.globalLanguageCode = ${MainState.globalLanguageCode}");
                ...
                Expanded(
                  ...
                  child: GestureDetector(
                    child: Container(
                      ...
                      margin: EdgeInsets.only(right: 60.px2Dp),
                      child: Text(
